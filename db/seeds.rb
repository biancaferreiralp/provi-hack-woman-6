...
provi = User.create!(company_name: "Provi", website: "provi.com", description: "Todos os dias, trabalhamos para superar desafios, trocar experiências e aprender cada vez mais. Somos mais de 400 pessoas, que colaboram, transformam e caminham na direção do nosso propósito, que é trazer soluções inovadoras para melhorar a vida de cada cliente.", 
...
grupo_boticario = User.create!(company_name: "Grupo Boticário", website: "grupoboticario.com", description: "Todos os dias, trabalhamos para superar desafios, trocar experiências e aprender cada vez mais. Somos mais de 400 pessoas, que colaboram, transformam e caminham na direção do nosso propósito, que é trazer soluções inovadoras para melhorar a vida de cada cliente.", 
...
wavy = User.create!(company_name: "Wavy", website: "wavy.com", description: "Todos os dias, trabalhamos para superar desafios, trocar experiências e aprender cada vez mais. Somos mais de 400 pessoas, que colaboram, transformam e caminham na direção do nosso propósito, que é trazer soluções inovadoras para melhorar a vida de cada cliente.", 
...
pagar_me = User.create!(company_name: "Pagar.me", website: "pagar.me", description: "Todos os dias, trabalhamos para superar desafios, trocar experiências e aprender cada vez mais. Somos mais de 400 pessoas, que colaboram, transformam e caminham na direção do nosso propósito, que é trazer soluções inovadoras para melhorar a vida de cada cliente.", 
...
credere = User.create!(company_name: "Credere", website: "credere.com", description: "Todos os dias, trabalhamos para superar desafios, trocar experiências e aprender cada vez mais. Somos mais de 400 pessoas, que colaboram, transformam e caminham na direção do nosso propósito, que é trazer soluções inovadoras para melhorar a vida de cada cliente.", 
...
enjoei = User.create!(company_name: "Enjoei", website: "enjoei.com", description: "Todos os dias, trabalhamos para superar desafios, trocar experiências e aprender cada vez mais. Somos mais de 400 pessoas, que colaboram, transformam e caminham na direção do nosso propósito, que é trazer soluções inovadoras para melhorar a vida de cada cliente.", 
